...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.long1:
                Toast.makeText(MainActivity.this, "context FIRST is clicked", Toast.LENGTH_SHORT).show();
                break;
            case R.id.long2:
                Toast.makeText(MainActivity.this, "context SECOND is clicked", Toast.LENGTH_SHORT).show();
                break;
        }
